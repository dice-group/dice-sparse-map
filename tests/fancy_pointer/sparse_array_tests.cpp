...
struct CUSTOM {
    ...
    using Const_Iterator = boost::interprocess::offset_ptr<T const>;
};
...
BOOST_AUTO_TEST_CASE(std_alloc_compile) {
    compilation<STD<int>>();
}
BOOST_AUTO_TEST_CASE(std_alloc_construction) {
    construction<STD<int>>();
}
BOOST_AUTO_TEST_CASE(std_alloc_set) {
    set<STD<int>>();
}
BOOST_AUTO_TEST_CASE(std_alloc_copy_construction) {
    copy_construction<STD<int>>();
}
BOOST_AUTO_TEST_CASE(std_alloc_move_construction) {
    move_construction<STD<int>>();
}
BOOST_AUTO_TEST_CASE(std_const_iterator) {
    const_iterator<STD<int>>();
}

BOOST_AUTO_TEST_CASE(custom_alloc_compile) {
    compilation<CUSTOM<int>>();
}
BOOST_AUTO_TEST_CASE(custom_alloc_construction) {
    construction<CUSTOM<int>>();
}
BOOST_AUTO_TEST_CASE(custom_alloc_set) {
    set<CUSTOM<int>>();
}
BOOST_AUTO_TEST_CASE(custom_alloc_copy_construction) {
    copy_construction<CUSTOM<int>>();
}
BOOST_AUTO_TEST_CASE(custom_alloc_move_construction) {
    move_construction<CUSTOM<int>>();
}
BOOST_AUTO_TEST_CASE(custom_const_iterator) {
    const_iterator<CUSTOM<int>>();
}
